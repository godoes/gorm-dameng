...
func (Dm_build_687 *dm_build_649) Dm_build_686(dm_build_688 []byte, dm_build_689 int, dm_build_690 uint8) int {
	dm_build_688[dm_build_689] = dm_build_690
	return 1
}
...
func (Dm_build_771 *dm_build_649) Dm_build_770(dm_build_772 []byte, dm_build_773 int) uint8 {
	return dm_build_772[dm_build_773] & 0xff
}
...
func (Dm_build_903 *dm_build_649) Dm_build_902(dm_build_904 []byte, dm_build_905 string, _ *DmConnection) string {
	...
	for {
		...
		if dm_build_927.dm_build_917 != dm_build_927.dm_build_918 || dm_build_927.dm_build_912 != nil {
			...
			case dm_build_930 == nil:
				...
				continue
			case errors.Is(dm_build_930, transform.ErrShortDst) && (dm_build_927.dm_build_915 != 0 || dm_build_929 != 0):

				continue
			case errors.Is(dm_build_930, transform.ErrShortSrc) && dm_build_927.dm_build_918-dm_build_927.dm_build_917 != len(dm_build_927.dm_build_916) && dm_build_927.dm_build_912 == nil:
