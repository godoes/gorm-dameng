...
const (
	...
	EXP_MAX           = 0xFF - 1 - FLAG_POSITIVE
	EXP_MIN           = FLAG_NEGTIVE + 1 - 0x7F
...
func (d *DmDecimal) Scan(src interface{}) error {
	if d == nil {
	...
	case int, int8, int16, int32, int64:
		dNew, err := NewDecimalFromInt64(reflect.ValueOf(src).Int())
		if err != nil {
			return err
		}
		*d = *dNew
	...
	case uint, uint8, uint16, uint32, uint64:
		dNew, err := NewDecimalFromBigInt(new(big.Int).SetUint64(reflect.ValueOf(src).Uint()))
		if err != nil {
			return err
		}
		*d = *dNew
	...
	case float32, float64:
		dNew, err := NewDecimalFromFloat64(reflect.ValueOf(src).Float())
		if err != nil {
			return err
		}
		*d = *dNew
		return nil
	case string:
		dNew, err := NewDecimalFromString(src)
		if err != nil {
			return err
		}
		*d = *dNew
