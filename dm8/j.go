...
// NewDmArray 数据库自定义数组Array构造函数，typeName为库中定义的数组类型名称，elements为该数组类型的每个值
//
...
// GetBaseTypeName 获取Array对象在数据库中的类型名称
...
// GetObjArray 获取Array对象的指定偏移和执行长度go数据对象 index从0开始
